...
class OdmDatabaseWrapper:
    ...
    #
    # @staticmethod
    # def VerifyCredentials(database_details):
    #     proc_args = [False]
    #     tester_proc = Process(target=OdmDatabaseWrapper._OdmDatabaseConnectionTestTimed, args=(database_details.ToDict(), success,))
    #     tester_proc.start()
    #     tester_proc.join(5)
    #     print 'Return value is...' + str(success)
    #     return success[0]
    #     # return service_manager.test_connection(database_details.ToDict())
    #
    # @staticmethod
    # def _OdmDatabaseConnectionTestTimed(db_auth, return_val):
    #     print return_val
    #
