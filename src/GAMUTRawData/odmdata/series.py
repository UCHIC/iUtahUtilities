...
class Series(Base):
    ...
    data_values = relationship("DataValue",
                               ...
                               foreign_keys="[DataValue.site_id, DataValue.variable_id, DataValue.method_id, "
                                            "DataValue.source_id, DataValue.quality_control_level_id]",
    ...
    def __repr__(self):
        return "<Series(%s, %s, %s, %s, %s-%s)>" % (
        self.id, self.site_code, self.variable_code, self.quality_control_level_code, self.begin_date_time,
        self.end_date_time)
